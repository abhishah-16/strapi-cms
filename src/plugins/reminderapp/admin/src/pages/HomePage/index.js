...
function HomePage() {
  ...
  async function updateReminder(id, data) {
    await ReminderApiHandler.editReminder(id, { "remindername": data.name, "date": data.date, 'datetime': new Date(data.date) })
    FetchReminders()
  }

  function addReminder(data) {
    ReminderApiHandler.addReminder({ "name": data.name, "date": data.date, "datetime": new Date(data.date), "isdatepassed": false })
    FetchReminders()
  }
